...
def get_supported_datamodules():
    from datamodels.lidc_datamodule import LIDCDataModule
    from datamodels.isic18_datamodule import ISIC18DataModule
...
def get_supported_models():
    from lightning_models.softmax_output import SoftmaxOutput
    from lightning_models.mc_dropout import MCDropout
    from lightning_models.probabilistic_unet import ProbUnet
    from lightning_models.ensemble import Ensemble
